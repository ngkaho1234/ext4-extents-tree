...
#define xfree(x) { \
	if (!x) \
		fprintf(stderr, "Warning, nil freeing. line: %d\n", __LINE__); \
	if (x) \
		free(x); \
}
...
#define be64_to_cpu(x) ((u64)(__be64)(x))
#define cpu_to_be32(x) ((__be32)(u32)(x))
#define be32_to_cpu(x) ((u32)(__be32)(x))
#define cpu_to_be16(x) ((__be16)(u16)(x))
#define be16_to_cpu(x) ((u16)(__be16)(x))
...
#define cpu_to_be64(x) ((__be64)(u64)(bswap_64(x)))
#define be64_to_cpu(x) ((u64)(__be64)(bswap_64(x)))
#define cpu_to_be32(x) ((__be32)(u32)(bswap_32(x)))
#define be32_to_cpu(x) ((u32)(__be32)(bswap_32(x)))
#define cpu_to_be16(x) ((__be16)(u16)(bswap_16(x)))
#define be16_to_cpu(x) ((u16)(__be16)(bswap_16(x)))
